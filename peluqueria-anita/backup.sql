...
--
-- Host: localhost    Database: peluqueria_anita
-- ------------------------------------------------------
...
CREATE TABLE `attentions` (
  ...
  `start_time` time NOT NULL,
  `end_time` time NOT NULL,
  `status` enum('started','in_progress','completed','cancelled') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'started',
  `service_price` decimal(10,2) NOT NULL,
  `observations` text COLLATE utf8mb4_unicode_ci,
  `products_used` text COLLATE utf8mb4_unicode_ci,
  `tip_amount` decimal(8,2) NOT NULL DEFAULT '0.00',
  `client_satisfaction` enum('very_unsatisfied','unsatisfied','neutral','satisfied','very_satisfied') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `notes` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `payments` (
  ...
  `payment_method` enum('cash','card','transfer','digital') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `users` (
  ...
  `role` enum('admin','stylist','client') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'client',
...
-- Dump completed on 2025-10-04 19:04:19
